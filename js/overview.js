$(document).ready(function(){
    ...
    if (currency=="BHD") {
        ...
        $("#OMR").addClass("hide");
                ...
                image = "http://wavetest.elasticbeanstalk.com/admin/"+results.rows.item(i).image;
                image1 = "http://wavetest.elasticbeanstalk.com/admin/"+results.rows.item(i).image1;
                image2 = "http://wavetest.elasticbeanstalk.com/admin/"+results.rows.item(i).image2;
                image3 = "http://wavetest.elasticbeanstalk.com/admin/"+results.rows.item(i).image3;
